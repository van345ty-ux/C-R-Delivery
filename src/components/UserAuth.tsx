...
import { ArrowLeft, ArrowRight, User, Mail, Phone, Calendar, Lock } from 'lucide-react';
...
export const UserAuth: React.FC<UserAuthProps> = ({ onBack, onGoToMenu }) => {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
        <div className="flex items-center mb-6">
          ...
          <button onClick={onGoToMenu} className="ml-4 text-red-600 hover:text-red-700">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-sm text-gray-500">Ir para cardápio →</span>
        </div>
