...
import { User as UserIcon, Mail, Phone, Calendar, LogOut, X, ShoppingBag, Gift, Edit } from 'lucide-react'; // Adicionado Edit icon
...
interface UserProfileProps {
  ...
  onUserUpdate: () => void; // Nova prop para recarregar o usuário no App.tsx
}

export const UserProfile: React.FC<UserProfileProps> = ({ user, onClose, onLogout, onViewOrder, onUserUpdate }) => {
