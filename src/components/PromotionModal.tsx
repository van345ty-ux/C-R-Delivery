                    ...
                    <div className="text-left">
                      {isPromotion ? (
                        <>
                          ...
                          <span className="text-lg font-bold text-red-600 block"> {/* Alterado para text-red-600 */}
                            R$ {promotion.price.toFixed(2)}
                          </span>
                        </>
                      ) : (
                        <span className="text-lg font-bold text-red-600"> {/* Alterado para text-red-600 */}
                          R$ {promotion.price.toFixed(2)}
                        </span>
                      )}
                    </div>
