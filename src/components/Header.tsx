...
import { MapPin, User as UserIcon, ShoppingCart, Settings, ArrowLeft, Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <img src={logoUrl} alt="C&R Sushi Logo" className="h-10 w-10 mr-3 rounded-full" />
            <div>
              <h1 className="text-xl font-bold text-red-600">C&R SUSHI</h1>
